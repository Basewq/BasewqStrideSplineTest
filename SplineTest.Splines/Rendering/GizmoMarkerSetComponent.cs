...
[DefaultEntityComponentRenderer(typeof(GizmoMarkerSetRenderProcessor))]
[AllowMultipleComponents]
[Display(Browsable = false)]    // Only allow creating at run-time
[DataContractIgnore]
public class GizmoMarkerSetComponent : ActivableEntityComponent
{
    public GizmoMarkerSet GizmoMarkerSet { get; set; } = new();
